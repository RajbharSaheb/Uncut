...
URL = "https://filestream-jagadishbotz.koyeb.app".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://filestream-jagadishbotz.koyeb.app/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://filestream-jagadishbotz.koyeb.app/".format(FQDN)
else:
    URL = "https://filestream-jagadishbotz.koyeb.app/".format(FQDN)
